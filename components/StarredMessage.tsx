...
const StarredMessage: React.FC<NavigationInjectedProps> = React.memo(
  ({ navigation }) => {
    return (
        ...
        <View style={styles.starredMsgPrt}>
          ...
          <View style={styles.me}>
            <Text style={{ color: "#fff" }}>
              ...
              asperiores repellendus iusto quam eveniet quidem molestias id,
              illum rerum eligendi voluptate
            </Text>
